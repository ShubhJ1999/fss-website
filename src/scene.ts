// Three.js stage: renderer, scene, camera, lights, post-processing.
...
function showWebGLFallback() {
  ...
  banner.innerHTML = 'This site needs WebGL. Enable hardware acceleration in your browser ' +
    '(<code>chrome://settings/system</code> → "Use graphics acceleration") and reload, ' +
    'or open this page in Safari or Firefox.';
